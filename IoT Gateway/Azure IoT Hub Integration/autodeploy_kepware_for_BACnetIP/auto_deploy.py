...
#
#  Procedure:
#       1- Ingests a setup file (setup.json) to determine values for the following critical variables:
...
#       2- Creates a single BACnet channel and a single IoT Gateway MQTT agent from JSON object templates 
#       located in the script's 'objs' local directory
#       3- Ingests a CSV file located in the script's 'csvs' local directory
#           ex. Device, Name, ObjectType, Instance
#               1210100, AV_0, 2, 0
#       
#               This yields Device with name "1210100" and tag with name "AV_0" and address of 
#               "AnalogValue.0.PresentValue" and an IoT item reference to 
#               "<channelNameDefinedinSetupFile>.<DeviceInstanceNumber>.<TagName>" i.e. B121.1210100.AV_0
# 
# ******************************************************************************/
